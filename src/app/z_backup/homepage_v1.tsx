    ...
    <div className="min-h-screen bg-[#efefef] px-6 py-8 text-gray-700">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h1 className="text-5xl font-light tracking-wide text-gray-700">
              Maintelyd
            </h1>
          </div>

<div className="relative group max-w-[320px]">
  {/* Main Button inside the Header*/}
  <button
    className="
      w-full border border-gray-500 bg-white px-6 py-4
  ...
  <div
    className="
      invisible absolute right-0 top-full z-50 mt-1 w-[320px]
      border border-gray-400 bg-white opacity-0 shadow-lg
